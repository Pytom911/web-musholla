...
$totalDana = mysqli_fetch_assoc(mysqli_query(
    $connect,
    "SELECT SUM(nominal) AS total FROM infaq $where"
));

$totalDonatur = mysqli_fetch_assoc(mysqli_query(
    $connect,
    "SELECT COUNT(DISTINCT nama_donatur) AS total FROM infaq $where"
));

$totalTransaksi = mysqli_fetch_assoc(mysqli_query(
    $connect,
    "SELECT COUNT(*) AS total FROM infaq $where"
));

$bulanIni = mysqli_fetch_assoc(mysqli_query(
    $connect,
...
$data = mysqli_query(
    $connect,
    "SELECT * FROM infaq $where ORDER BY tanggal DESC, id_infaq DESC"
);
?>
    ...
    <form method="GET">
        ...
        <div class="row g-3 align-items-end">
            ...
            <div class="col-lg-6 d-flex gap-2">
                ...
                <a href="laporan-infaq.php" class="btn-reset">
...
<div class="data-card">
    ...
    <div class="data-toolbar">
        ...
        <div class="toolbar-right">
            <select class="form-select" id="showData">
                ...
                <tr>
                    <td colspan="4">
                        <div class="empty-data">
                            ...
                            <p>Tidak ada data infaq pada periode yang dipilih.</p>
                        </div>
                    </td>
                </tr>
