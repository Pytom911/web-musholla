    ...
    <div class="data-card">
        ...
        <div class="data-toolbar">
            ...
            <div class="search-box">
                ...
                <input type="text" id="searchInput" placeholder="Cari nama kegiatan..." value="<?= htmlspecialchars($cari); ?>">
            </div>
                    ...
                    <tr>
                        ...
                        <td>
                            ...
                            <div class="action-group">
                                ...
                                <a href="hapus.php?id=<?= $row['id_kegiatan']; ?>" class="btn-delete" onclick="return confirm('Yakin ingin menghapus data kegiatan ini?')">
