...
<head>
    ...
    <title>Sistem Informasi Musholla - Register</title>
    <!-- Bootstrap CSS -->
        ...
        <div class="row g-0 h-100">
            ...
            <div class="col-lg-6 d-flex align-items-center justify-content-center bg-white">
                <div class="login-container">
                    ...
                    <h1 class="login-title text-center mb-2">Register</h1>
                    <p class="login-subtitle text-center mb-4">Please register to login</p>
                    ...
                    <form method="POST" id="loginForm">
                        ...
                        <div class="d-flex justify-content-between align-items-center mb-4 text-small">
                            ...
                            <a href="forget_pass.php" class="forgot-link">Masuk</a>
                        </div>
