...
$role = $_SESSION['role'] ?? '';
$foto = basename($_SESSION['foto'] ?? 'default_profile.jpg');
?>
<!DOCTYPE html>
<html lang="id">
<head>
        ...
        <?php if ($isLoggedIn): ?>
            ...
            <div class="user-profile dropdown">
                <a href="#" class="d-flex align-items-center text-decoration-none dropdown-toggle" id="dropdownUser" data-bs-toggle="dropdown" aria-expanded="false">
                    ...
                    <img src="<?= asset('img/' . $foto) ?>" alt="Profile" class="user-avatar rounded-circle object-fit-cover shadow-sm border border-2 border-white" width="45" height="45">
                </a>

                <!-- Dropdown Menu -->
                <ul class="dropdown-menu dropdown-menu-end shadow border-0 mt-2" aria-labelledby="dropdownUser">
                    <li><h6 class="dropdown-header d-md-none"><?= htmlspecialchars($nama) ?></h6></li>
                    <li><hr class="dropdown-divider"></li>
                    <li><a class="dropdown-item py-2 text-danger" href="<?= url('auth/logout.php') ?>"><i class="bi bi-box-arrow-right me-2"></i> Logout</a></li>
                </ul>
            </div>
        <?php else: ?>
